...
$query=$conn->query("insert into analytics(name)values('$name')");
if($query){
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">Big Data/Analytics</span>
</div>
...
<img src="techpic/bigdatanyalytics.jpg" alt="Girl in a jacket" width="1100" height="400">
  <!-- Header -->
...
<body>
    ...
    <p>Big data analytics is the often complex process of examining big data to uncover information such as hidden patterns, correlations, market trends and customer preferences that can help organizations make informed business decisions.<br><br>

On a broad scale, data analytics technologies and techniques provide a means to analyze data sets and take away new information—which can help organizations make informed business decisions. Business intelligence (BI) queries answer basic questions about business operations and performance.</p>
		<br />
		...
		<table cellpadding="" cellspacing="0" border="1" class="table table-striped table-bordered" id="example">
			<thead>
				<tr>
					<h1><th width="100%" align="center">Big Data/Analytics Files to Downlonad</th></h1>
					<th align="center">Action</th>	
				</tr>
			</thead>
			<?php
			$query=$conn->query("select * from analytics order by id desc");
