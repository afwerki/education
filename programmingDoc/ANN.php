...
$query=$conn->query("insert into ann(name)values('$name')");
if($query){
...
<!DOCTYPE html>
<html>
<title>ANN(Artificial neural network)</title>
<meta charset="UTF-8">
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">ANN(Artificial neural network)</span>
</div>
...
<img src="techpic/ANN.png" alt="Girl in a jacket" width="1100" height="400">
  <!-- Header -->
...
<body>
    ...
    <p>An ANN is based on a collection of connected units or nodes called artificial neurons, which loosely model the neurons in a biological brain. Each connection, like the synapses in a biological brain, can transmit a signal to other neurons. An artificial neuron that receives a signal then processes it and can signal neurons connected to it. The "signal" at a connection is a real number, and the output of each neuron is computed by some non-linear function of the sum of its inputs. The connections are called edges. Neurons and edges typically have a weight that adjusts as learning proceeds.
		...
		<table cellpadding="" cellspacing="0" border="1" class="table table-striped table-bordered" id="example">
			<thead>
				<tr>
					<h1><th width="100%" align="center">ANN(Artificial neural network) Files to Downlonad</th></h1>
					<th align="center">Action</th>	
				</tr>
			</thead>
			<?php
			$query=$conn->query("select * from ann order by id desc");
