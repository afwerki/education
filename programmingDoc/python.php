...
$query=$conn->query("insert into python(name)values('$name')");
if($query){
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">Python</span>
</div>
...
<img src="propic/python.jpg" alt="Girl in a jacket" width="1100" height="300">
  <!-- Header -->
...
Python is dynamically typed and garbage-collected. It supports multiple programming paradigms, including structured (particularly, procedural), object-oriented, and functional programming. Python is often described as a "batteries included" language due to its comprehensive standard library.</p>
		...
		<table cellpadding="" cellspacing="0" border="1" class="table table-striped table-bordered" id="example">
			<thead>
				<tr>
					<h1><th width="100%" align="center">python Files to Downlonad</th></h1>
					<th align="center">Action</th>	
				</tr>
			</thead>
			<?php
			$query=$conn->query("select * from python order by id desc");
