...
$query=$conn->query("insert into htmlandcss(name)values('$name')");
if($query){
header("location:htmlandcss.php");
}
else{
die(mysql_error());
}
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">HTML and Css</span>
</div>
...
<img src="propic/htmlandcss.jpg" alt="Girl in a jacket" width="1100" height="300">
  <!-- Header -->
...
<body>
    ...
    <p>HTML (the Hypertext Markup Language) and CSS (Cascading Style Sheets) are two of the core technologies for building Web pages. HTML provides the structure of the page, CSS the (visual and aural) layout, for a variety of devices.</p>
		...
		<table cellpadding="" cellspacing="0" border="1" class="table table-striped table-bordered" id="example">
			...
			<?php
			$query=$conn->query("select * from htmlandcss order by id desc");
