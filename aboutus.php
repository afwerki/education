...
<div class="w3-hide-large w3-hide-large w3-padding-16">
 <div class="w3-center notranslate"><a class='w3schools-logo' href='//www.w3schools.com'>STUDENTS <span class='dotcom'>TO STUDETS</span></a></div>
...
<div class="w3-bar-block">
 ...
 <a class="w3-bar-item w3-button" href="/html/default.asp">HTML AND CSS</a>
 <a class="w3-bar-item w3-button" href="/css/default.asp">JAVASCRIPT</a>
 <a class="w3-bar-item w3-button" href="/bootstrap/bootstrap_ver.asp">PHP</a>
 <a class="w3-bar-item w3-button" href="/w3css/default.asp"></a>
 <a class="w3-bar-item w3-button" href="/colors/default.asp">JAVA</a>
 <a class="w3-bar-item w3-button" href="/icons/default.asp">C#</a>
 <a class="w3-bar-item w3-button" href="/graphics/default.asp">PYTHON</a>
 <a class="w3-bar-item w3-button" href="/howto/default.asp">DATA SCINCE</a>
 <a class="w3-bar-item w3-button" href="/sass/default.asp">ANN(ARTIFICIAL NURAL NETWORK</a> 
 <div class="w3-container">
  <h4 class="w3-margin-top">NATURAL SCINCE</h4>
 </div>
 <a class="w3-bar-item w3-button" href="/js/default.asp">ASTRONOMY</a>
 <a class="w3-bar-item w3-button" href="/jquery/default.asp">Biology</a>
 <a class="w3-bar-item w3-button" href="/react/default.asp">Chemistry</a>
 <a class="w3-bar-item w3-button" href="/angular/default.asp">Physics</a>
 <a class="w3-bar-item w3-button" href="/js/js_json_intro.asp">Earth science</a>
 <a class="w3-bar-item w3-button" href="/js/js_ajax_intro.asp">Human anatomy</a>
 <a class="w3-bar-item w3-button" href="/w3js/default.asp">MEDICAL SEINCE</a>
 <div class="w3-container">
  <h4 class="w3-margin-top">SOCIAL SICNCE</h4>
 </div>
 <a class="w3-bar-item w3-button" href="/sql/default.asp">Anthropology</a>
 <a class="w3-bar-item w3-button" href="/php/default.asp">Archaeology</a>
 <a class="w3-bar-item w3-button" href='/asp/default.asp'>Economics</a>
 <a class="w3-bar-item w3-button" href='/nodejs/default.asp'>Geography</a>
 <a class="w3-bar-item w3-button" href='/nodejs/nodejs_raspberrypi.asp'>History</a>
 <a class="w3-bar-item w3-button" href='/nodejs/nodejs_raspberrypi.asp'>Law</a>
 <a class="w3-bar-item w3-button" href='/nodejs/nodejs_raspberrypi.asp'>Political science</a>
 <a class="w3-bar-item w3-button" href='/nodejs/nodejs_raspberrypi.asp'>Sociology</a>
...
<nav id="nav_exercises" class="w3-light-grey w3-card-2 w3-hide-small w3-hide-medium navex">
 ...
 <div class="w3-row-padding w3-bar-block">
  <div class="w3-col l4 m12">
   ...
   <a class="w3-bar-item w3-button" href="/html/html_exercises.asp">Algebra</a>
   <a class="w3-bar-item w3-button" href="/css/css_exercises.asp">Calculus and analysis</a>
   <a class="w3-bar-item w3-button" href="/js/js_exercises.asp">Geometry and topology</a>
   <a class="w3-bar-item w3-button" href="/sql/sql_exercises.asp">Combinatorics</a>
   <a class="w3-bar-item w3-button" href="/php/php_exercises.asp">Logic</a>
   <a class="w3-bar-item w3-button" href="/python/python_exercises.asp">Applied mathematics</a>
   <a class="w3-bar-item w3-button" href="/jquery/jquery_exercises.asp">Mathematical physics</a>
   <a class="w3-bar-item w3-button" href="/java/java_exercises.asp"> Probability and statistics</a>
  </div>
