...
<html lang="en-US">
<head>
<title>Students to Students Support</title>
<meta charset="utf-8">
...
.w3-theme {color:#fff !important;background-color:#00c5cc !important;}
...
<div class="w3-row w3-white w3-padding w3-hide-medium w3-hide-small" style="margin-top:5px;">
 ...
 <div class="w3-col s5 notranslate" style="margin:4px 0 6px 0"><a class='w3schools-logo' href='#'>Studetns To<span class='dotcom'>Students</span></a></div>
 <h4>CLICK SUBJECTS TO UPLOADE OR DOWNLOAD THE FILE</h4>
 <div class="w3-col s7 w3-margin-top w3-wide w3-hide-medium w3-hide-small">
  <div class="w3-right" style="position:relative;top:5px;">THE WORLD'S LARGEST STUDENTS PLATFORM</div>
 </div>
</div>

<div class="w3-hide-large w3-hide-large w3-padding-16">
 <div class="w3-center notranslate"><a class='w3schools-logo' href='/socialDoc/index.php'>STUDENTS <span class='dotcom'>TO STUDETS</span></a></div>
 <div class="w3-center w3-wide w3-hide-small" style="margin:14px 0 -5px 0">THE WORLD'S LARGEST WEB DEVELOPER SITE</div>
</div>
<h4><button><a href="admin/index.php">Admin Login</a></button></h4>
...
<div class="w3-bar w3-theme w3-card-2 w3-wide notranslate">
 ...
 <a class="w3-bar-item w3-button barex w3-hover-white w3-padding-16" href="javascript:void(0)" onclick="w3_open_nav('tutorials')" id="navbtn_tutorials">TEHCNOLOGY <i class='fa fa-caret-down'></i><i class='fa fa-caret-up' style="display:none"></i></a>


 <a class="w3-bar-item w3-button barex w3-hover-white w3-padding-16" href="javascript:void(0)" onclick="w3_open_nav('references')" id="navbtn_references">SOCIAL SCINCE <i class='fa fa-caret-down'></i><i class='fa fa-caret-up' style="display:none"></i></a>
 <a class="w3-bar-item w3-button barex w3-hover-white w3-padding-16" href="javascript:void(0)" onclick="w3_open_nav('examples')" id="navbtn_examples">NATURAL SCINCE<i class='fa fa-caret-down'></i><i class='fa fa-caret-up' style="display:none"></i></a>
 <a class="w3-bar-item w3-button barex w3-hover-white w3-padding-16 w3-hide-medium w3-hide-small" href="javascript:void(0)" onclick="w3_open_nav('exercises')" id="navbtn_exercises">MATHS <i class='fa fa-caret-down'></i><i class='fa fa-caret-up' style="display:none"></i></a>
 <div class="w3-right">
...
<div class="w3-bar-block">
 ...
 <a class="w3-bar-item w3-button" href="techDoc/index.php">HTML AND CSS</a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php">JAVASCRIPT</a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php">PHP</a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php"></a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php">JAVA</a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php">C#</a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php">PYTHON</a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php">DATA SCINCE</a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php">ANN(ARTIFICIAL NURAL NETWORK</a> 
 <div class="w3-container">
  <h4 class="w3-margin-top">NATURAL SCINCE</h4>
 </div>
 <a class="w3-bar-item w3-button" href="naturalDoc/index.php">ASTRONOMY</a>
 <a class="w3-bar-item w3-button" href="naturalDoc/index.php">Biology</a>
 <a class="w3-bar-item w3-button" href="naturalDoc/index.php">Chemistry</a>
 <a class="w3-bar-item w3-button" href="naturalDoc/index.php">Physics</a>
 <a class="w3-bar-item w3-button" href="naturalDoc/index.php">Earth science</a>
 <a class="w3-bar-item w3-button" href="naturalDoc/index.php">Human anatomy</a>
 <a class="w3-bar-item w3-button" href="naturalDoc/index.php">MEDICAL SEINCE</a>
 <div class="w3-container">
  <h4 class="w3-margin-top">SOCIAL SICNCE</h4>
 </div>
 <a class="w3-bar-item w3-button" href="socialDoc/index.php">Anthropology</a>
 <a class="w3-bar-item w3-button" href="socialDoc/index.php">Archaeology</a>
 <a class="w3-bar-item w3-button" href="socialDoc/index.php">Economics</a>
 <a class="w3-bar-item w3-button" href="socialDoc/index.php">Geography</a>
 <a class="w3-bar-item w3-button" href="socialDoc/index.php">History</a>
 <a class="w3-bar-item w3-button" href="socialDoc/index.php">Law</a>
 <a class="w3-bar-item w3-button" href="socialDoc/index.php">Political science</a>
 <a class="w3-bar-item w3-button" href="socialDoc/index.php">Sociology</a>
...
<div id='myAccordion' class="w3-card-2 w3-light-grey w3-center w3-hide-large" style="display:none;cursor:default">
 ...
 <div class="w3-container w3-padding-32">
  <a class="w3-button w3-block w3-large w3-wide" onclick="open_xs_menu('tutorials');" href="javascript:void(0);">TECHNOLOGY<i class='fa fa-caret-down'></i></a>
  <div id="sectionxs_tutorials" class="w3-white w3-show"></div>
  <a class="w3-button w3-block w3-large w3-wide" onclick="open_xs_menu('references')" href="javascript:void(0);">SOCIAL SCINCE<i class='fa fa-caret-down'></i></a>
  <div id="sectionxs_references" class="w3-white w3-show"></div>
  <a class="w3-button w3-block w3-large w3-wide" onclick="open_xs_menu('examples')" href="javascript:void(0);">NATURAL SCINCE<i class='fa fa-caret-down'></i></a>
  <div id="sectionxs_examples" class="w3-white w3-show"></div>
  <a class="w3-button w3-block w3-large w3-wide" onclick="open_xs_menu('exercises')" href="javascript:void(0);">MATHS<i class='fa fa-caret-down'></i></a>
...
<nav id="nav_tutorials" class="w3-light-grey w3-card-2 w3-hide-small navex">
 ...
 <div class="w3-row-padding w3-bar-block">
  <div class="w3-col l3 m6">
   <h3 class="w3-margin-top">TECHNOLOGY</h3>
 <a class="w3-bar-item w3-button" href="techDoc/index.php">HTML AND CSS</a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php">JAVASCRIPT</a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php">PHP</a>
 <a class="w3-bar-item w3-button" href="techDoc/index.php"></a>
 ...
 <div class="w3-col l3 m6">
   ...
   <a class="w3-bar-item w3-button" href="socialDoc/index.php">Learn SQL</a>
   <a class="w3-bar-item w3-button" href="socialDoc/index.php">Learn PHP</a>
   <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Learn ASP</a>
   <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Learn Node.js</a>
   <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Learn Raspberry Pi</a>

   <h3 class="w3-margin-top">Web Building</h3>
   <a class="w3-bar-item w3-button" href="socialDoc/index.php">Web Templates</a>
   <a class="w3-bar-item w3-button" href="socialDoc/index.php">Web Statistics</a>
   <a class="w3-bar-item w3-button" href="socialDoc/index.php">Web Certificates</a>
   <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Web Editor</a>
   <a class="w3-bar-item w3-button" href="socialDoc/index.php">Web Development</a>
   <a class="w3-bar-item w3-button" href="socialDoc/index.php">Test Your Typing Speed</a>
  </div>
  <div class="w3-col l3 m6 w3-hide-medium">
   <h3 class="w3-margin-top">XML Tutorials</h3>
   <a class="w3-bar-item w3-button" href="socialDoc/index.php">Learn XML</a>
   <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Learn XML AJAX</a>
   <a class="w3-bar-item w3-button" href="socialDoc/index.php">Learn XML DOM</a>
   <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Learn XML DTD</a>
   <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Learn XML Schema</a>
   <a class="w3-bar-item w3-button" href="socialDoc/index.php">Learn XSLT</a>
   <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Learn XPath</a>
   <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Learn XQuery</a>
  </div>
 </div>
 <br class="hidesm">
</nav>
...
<nav id="nav_references" class="w3-light-grey w3-card-2 w3-hide-small navex">
 ...
 <div class="w3-row-padding w3-bar-block">
  <div class="w3-col l3 m6">
   <h3 class="w3-margin-top">SOCIAL SINCE</h3>
 <a class="w3-bar-item w3-button" href="socialDoc/index.php">Anthropology</a>
 <a class="w3-bar-item w3-button" href="socialDoc/index.php">Archaeology</a>
 <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Economics</a>
 <a class="w3-bar-item w3-button" href='socialDoc/index.php'>Geography</a>
...
<nav id="nav_examples" class="w3-light-grey w3-card-2 w3-hide-small navex">
 ...
 <div class="w3-row-padding w3-bar-block">
  <div class="w3-col l3 m6">
   <h3 class="w3-margin-top">NATURAL SCINCE</h3>
  <a class="w3-bar-item w3-button" href="naturalDoc/index.php">ASTRONOMY</a>
 <a class="w3-bar-item w3-button" href="naturalDoc/index.php">Biology</a>
 <a class="w3-bar-item w3-button" href="naturalDoc/index.php">Chemistry</a>
 <a class="w3-bar-item w3-button" href="naturalDoc/index.php">Physics</a>
...
<nav id="nav_exercises" class="w3-light-grey w3-card-2 w3-hide-small w3-hide-medium navex">
 ...
 <div class="w3-row-padding w3-bar-block">
  <div class="w3-col l4 m12">
   <h3 class="w3-margin-top">MATHS</h3>
   <a class="w3-bar-item w3-button" href="maths/index.php">Algebra</a>
   <a class="w3-bar-item w3-button" href="maths/index.php">Calculus and analysis</a>
   <a class="w3-bar-item w3-button" href="maths/index.php">Geometry and topology</a>
   <a class="w3-bar-item w3-button" href="maths/index.php">Combinatorics</a>
   <a class="w3-bar-item w3-button" href="maths/index.php">Logic</a>
   <a class="w3-bar-item w3-button" href="maths/index.php">Applied mathematics</a>
   <a class="w3-bar-item w3-button" href="maths/index.php">Mathematical physics</a>
   <a class="w3-bar-item w3-button" href="maths/index.php"> Probability and statistics</a>
  </div>
...
<div class="w3-dark-grey w3-center w3-padding-large w3-padding-48" style="padding-bottom:68px!important">
  ...
  <div class="w3-row-padding w3-content">
    ...
    <div class="w3-third w3-hide-medium w3-hide-large">
      <p><a class="w3-btn w3-green w3-block w3-padding-16" href="/sql/sql_exercises.asp">SQL Exercises</a></p>
    </div>
    <div class="w3-third w3-hide-medium w3-hide-large">
      <p><a class="w3-btn w3-green w3-block w3-padding-16" href="/python/python_exercises.asp">Python Exercises</a></p>
    </div>
  </div>
