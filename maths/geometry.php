...
$query=$conn->query("insert into geometry(name)values('$name')");
if($query){
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">geometry</span>
</div>
...
<img src="mathspic/geometry.jpg" alt="Girl in a jacket" width="1100" height="300">
  <!-- Header -->
...
<body>
		...
		<h3>Geometry</h3>	
    <p>
Geometry (from the Ancient Greek: γεωμετρία; geo- "earth", -metron "measurement") is a branch of mathematics concerned with questions of shape, size, relative position of figures, and the properties of space.<br> A mathematician who works in the field of geometry is called a geometer.

Geometry arose independently in a number of early cultures as a practical way for dealing with lengths, areas, and volumes. Geometry began to see elements of formal mathematical science emerging in Greek mathematics as early as the 6th century BC. <br>By the 3rd century BC, geometry was put into an axiomatic form by Euclid, whose treatment, The Elements, set a standard for many centuries to follow.<br>Geometry arose independently in India, with texts providing rules for geometric constructions appearing as early as the 3rd century BC.<br> Islamic scientists preserved Greek ideas and expanded on them during the Middle Ages.<br> By the early 17th century, geometry had been put on a solid analytic footing by mathematicians such as René Descartes and Pierre de Fermat. Since then, and into modern times, geometry has expanded into non-Euclidean geometry and manifolds, describing spaces that lie beyond the normal range of human experience.</p>
		<br />
		...
		<table cellpadding="" cellspacing="0" border="1" class="table table-striped table-bordered" id="example">
			...
			<?php
			$query=$conn->query("select * from geometry order by id desc");
