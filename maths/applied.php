...
$query=$conn->query("insert into applied(name)values('$name')");
if($query){
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">Applied mathematics </span>
</div>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href=" probablity.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i> Probablity </a>
...
<img src="mathspic/applied.jpg" alt="Girl in a jacket" width="1100" height="300">
  <!-- Header -->
...
<body>
    ...
    <p>Applied mathematics is the application of mathematical methods by different fields such as physics, engineering, medicine, biology, business, computer science, and industry. Thus, applied mathematics is a combination of mathematical science and specialized knowledge. The term "applied mathematics" also describes the professional specialty in which mathematicians work on practical problems by formulating and studying mathematical models.<br>

In the past, practical applications have motivated the development of mathematical theories, which then became the subject of study in pure mathematics where abstract concepts are studied for their own sake. The activity of applied mathematics is thus intimately connected with research in pure mathematics.</p>
		<br />
		...
		<table cellpadding="" cellspacing="0" border="1" class="table table-striped table-bordered" id="example">
			...
			<?php
			$query=$conn->query("select * from applied order by id desc");
