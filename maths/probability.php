...
$query=$conn->query("insert into probability(name)values('$name')");
if($query){
header("location:probability.php");
}
else{
die(mysql_error());
}
...
<!DOCTYPE html>
<html>
<title>Mathematical Probability</title>
<meta charset="UTF-8">
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">Mathematical Probability</span>
</div>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="probablity.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>Mathematical Probability </a>
...
<img src="mathspic/probability.png" alt="Girl in a jacket" width="1100" height="300">
  <!-- Header -->
...
<body>
	    <div class="row-fluid">
	        <div class="span12">
	            <div class="container">
		<br />
		<h3>Mathematical Probability</h3>	
    <p>
Probability is the branch of mathematics concerning numerical descriptions of how likely an event is to occur or how likely it is that a proposition is true. <br>The probability of an event is a number between 0 and 1, where, roughly speaking, 0 indicates impossibility of the event and 1 indicates certainty.The higher the probability of an event, the more likely it is that the event will occur. <br>A simple example is the tossing of a fair (unbiased) coin. Since the coin is fair, the two outcomes ("heads" and "tails") are both equally probable; the probability of "heads" equals the probability of "tails"; and since no other outcomes are possible, the probability of either "heads" or "tails" is 1/2 (which could also be written as 0.5 or 50%).<br>
...
These concepts have been given an axiomatic mathematical formalization in probability theory, which is used widely in such areas of study as mathematics, statistics, finance, gambling, science (in particular physics), artificial intelligence/machine learning, computer science, game theory, and philosophy to, for example, draw inferences about the expected frequency of events. Probability theory is also used to describe the underlying mechanics and regularities of complex systems.</p>
		...
		<table cellpadding="" cellspacing="0" border="1" class="table table-striped table-bordered" id="example">
			...
			<?php
			$query=$conn->query("select * from probability order by id desc");
