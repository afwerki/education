...
$query=$conn->query("insert into mathsPhysics(name)values('$name')");
if($query){
header("location:mathsPhysics.php");
}
else{
die(mysql_error());
}
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">Mathematical physics</span>
</div>
...
<img src="mathspic/StationaryStatesAnimation.gif" alt="Girl in a jacket" width="1100" height="300">
  <!-- Header -->
...
<body>
    ...
    <p>
Mathematical physics refers to the development of mathematical methods for application to problems in physics.</p>
		<br />
		...
		<table cellpadding="" cellspacing="0" border="1" class="table table-striped table-bordered" id="example">
			...
			<?php
			$query=$conn->query("select * from mathsPhysics order by id desc");
